				...
				<div className="container">
					...
					<div className="text-center flex flex-col items-center mb-10 md:mb-50px">
						...
						<p
							...
							data-wow-delay=".4s"
						>
							I specialize in delivering modern web solutions using React, Next.js, and Sitecore. Whether its traditional or headless development, I turn business needs into powerful digital experiences.
						</p>
					</div>
					{/* <!-- services --> */}
